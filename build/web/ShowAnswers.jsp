                        ...
                        <span class="chat-img pull-left" style="height: 10px; width: 60px">
                            ...
                            <form class="input-group" method="post" action="PostAnswer.do?id=<%=qt.getqId()%>">
                                ...
                                <span class="input-group-btn">
                                    <c:choose>
                                    <c:when test="${none == 'none'}"><a class="btn btn-warning" href="login.jsp">Login to Post Your Answer</a></c:when>
                                    <c:otherwise><input type="submit" class="btn btn-warning btn-sm" value="Post" id="btn-chat"></c:otherwise>
                                    </c:choose>
                                </span>
                            </form>
                            </div><br/>
