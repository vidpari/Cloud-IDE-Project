			...
			<div class="row">
				<div
					...
					<div class="form-box-inner">
						<h2 class="title text-center">Log in to Krazzie Coding</h2>
						<div class="row">
							<div class="form-container col-md-5 col-sm-12 col-xs-12">
								<!-- form started-->
								<form class="login-form" method="post" action="Auth.do">
									<p>
									...
									<div class="form-group password">
										<label class="sr-only" for="login-password">Password</label> <input
											id="login-password" type="password" name="password" value=""
											class="form-control login-password" required placeholder="Password">
